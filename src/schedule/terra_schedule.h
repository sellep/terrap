...
extern BOOL terra_schedule_clock_init(terra_schedule_clock * const);
extern BOOL terra_schedule_hygro_init(terra_schedule_hygro * const);

extern void terra_schedule_run();
void terra_schedule_clock_run(terra_schedule_clock * const, terra_schedule * const);
void terra_schedule_hygro_run(terra_schedule_hygro * const, terra_schedule * const);
